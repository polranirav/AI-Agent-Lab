...
"""
    ...
    def run(self, topic: str, user_id: Optional[str] = None) -> dict:
        ...
        try:
            # Observability: time the run and persist latency/tokens/cost.
            with run_timer(self._run_id, self._session_id, model=ORCHESTRATOR_MODEL):
    ...
    def _run(self, topic: str) -> dict:
        ...
        for iteration in range(10):
            ...
            if response.usage and self._run_id:
                add_token_usage(self._run_id,
